...
curl https://raw.githubusercontent.com/Rodi-1/TRPP_PR2/master/part2/requirements.txt?token=GHSAT0AAAAAACQHYBZOWEI4KIU7ZMEUZXR2ZQFPNJQ -o requirements.txt
